import ChannelMessageUploadTypeService from '../../../src/graph-based/services/channel_message_upload_type_service.js';
...
test.each([
    ...
    [ { name: 1 }, 'ChannelMessageUploadType not found' ],
    [ { name: "test" }, 'ChannelMessageUploadType not found' ],
