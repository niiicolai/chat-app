import ChannelMessageTypeService from '../../../src/graph-based/services/channel_message_type_service.js';
...
test.each([
    ...
    [ 'System' ],
    [ 'Webhook' ],
])('ChannelMessageTypeService.findOne valid partitions', async (name) => {
...
test.each([
    ...
    [ { name: 1 }, 'ChannelMessageType not found' ],
    [ { name: "test" }, 'ChannelMessageType not found' ],
])('ChannelMessageTypeService.findOne invalid partitions', async (options, expected) => {
...
test.each([
    ...
    [ { limit: 2, page: 2 } ],
    [ { limit: 1, page: 3 } ],
])('ChannelMessageTypeService.findAll valid partitions', async (options) => {
...
])('ChannelMessageTypeService.findAll invalid partitions', async (options, expected) => {
