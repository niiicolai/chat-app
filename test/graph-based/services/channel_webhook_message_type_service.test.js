import ChannelWebhookMessageTypeService from '../../../src/graph-based/services/channel_webhook_message_type_service.js';
...
test.each([
    ...
    [ { name: 1 }, 'ChannelWebhookMessageType not found' ],
    [ { name: "test" }, 'ChannelWebhookMessageType not found' ],
