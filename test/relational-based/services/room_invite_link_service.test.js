...
import RoomUserService from '../../../src/relational-based/services/room_user_service.js';
import RoomInviteLinkService from '../../../src/relational-based/services/room_invite_link_service.js';
...
describe('RoomInviteLinkService Tests', async () => {
    ...
    test.each([
        ...
        expect(() => RoomInviteLinkService.findOne(options)).rejects.toThrow("room_invite_link not found");
    });
