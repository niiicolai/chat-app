import UserService from '../../../src/relational-based/services/user_service.js';
import RoomService from '../../../src/relational-based/services/room_service.js';
...
describe('RoomService Tests', async () => {
    ...
    ])('RoomService.findOne valid partitions', async (options) => {
    ...
    ])('RoomService.findOne invalid partitions', async (options, expected) => {
    ...
    ])('RoomService.findAll valid partitions', async (options) => {
    ...
    ])('RoomService.findAll invalid partitions', async (options, expected) => {
    ...
    ])('RoomService.create valid partitions', async (options) => {
    ...
    ])('RoomService.create invalid partitions', async (options, expected) => {
    ...
    ])('RoomService.update valid partitions', async (options) => {
    ...
    ])('RoomService.update invalid partitions', async (options, expected) => {
    ...
    ])('RoomService.editSettings valid partitions', async (options) => {
    ...
    ])('RoomService.editSettings invalid partitions', async (options, expected) => {
    ...
    ])('RoomService.destroy valid partitions', async (options) => {
    ...
    test.each([
        ...
        [{ uuid: "test", user: { } }, 'No user.sub provided'],
        [{ uuid: "test", user: { sub: "test" } }, 'room not found'],
    ])('RoomService.destroy invalid partitions', async (options, expected) => {
    ...
    test('RoomService.findOne return error for users who are not members', async () => {
    ...
    test.each([
        ...
        [context.member.sub],
        [user.uuid],
    ])('RoomService.update return error for users who are not admin', async (sub) => {
    ...
    test.each([
        ...
        [context.member.sub],
        [user.uuid],
    ])('RoomService.destroy returns an error for users who are not admin', async (sub) => {
        await expect(RoomService.destroy({ uuid: context.room.uuid, user: { sub } }))
            .rejects
            .toThrow(/User is not an admin of the room|room not found/);
    });
    ...
    test.each([
        ...
        [context.member.sub],
        [user.uuid],
    ])('RoomService.editSettings returns an error for users who are not admin', async (sub) => {
