import crudService from '../../../services/mongodb/room_user_role_service.js';
...
/**
 * @openapi
 * '/api/v1/mongodb/room_user_role/{name}':
 *  get:
 *     tags:
 *       - MongoDB Room User Role Controller
...
/**
 * @openapi
 * '/api/v1/mongodb/room_user_roles':
 *  get:
 *      tags:
 *       - MongoDB Room User Role Controller
