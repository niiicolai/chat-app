...
export default (crudService) => {
    ...
    ctrl.findOne = () => {
        router.get('/room_file/:uuid', [originMiddleware, authMiddleware], async (req, res) => {
    ...
    ctrl.findAll = () => {
        router.get('/room_files', [originMiddleware, authMiddleware], async (req, res) => {
            await errorHandler(res, async () => {
    ...
    ctrl.destroy = () => {
        router.delete('/room_file/:uuid', [originMiddleware, csrfMiddleware, authMiddleware], async (req, res) => {
            await errorHandler(res, async () => {
