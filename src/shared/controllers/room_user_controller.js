...
export default (crudService) => {
    ...
    ctrl.findOne = () => {
        router.get('/room_user/:uuid', [originMiddleware, authMiddleware], async (req, res) => {
    ...
    ctrl.findAuthenticatedUser = () => {
        router.get('/room_user/me/:room_uuid', [originMiddleware, authMiddleware], async (req, res) => {
            await errorHandler(res, async () => {
    ...
    ctrl.findAll = () => {
        router.get('/room_users', [originMiddleware, authMiddleware], async (req, res) => {
            await errorHandler(res, async () => {
    ...
    ctrl.update = () => {
        router.patch('/room_user/:uuid', [originMiddleware, csrfMiddleware, authMiddleware], async (req, res) => {
            await errorHandler(res, async () => {
    ...
    ctrl.destroy = () => {
        router.delete('/room_user/:uuid', [originMiddleware, csrfMiddleware, authMiddleware], async (req, res) => {
            await errorHandler(res, async () => {
