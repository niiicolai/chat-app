...
const ctrl = googleAuthController(
    ...
    process.env.GOOGLE_MONGODB_ADD_REDIRECT_URL
);
...
/**
 * @openapi
 * '/api/v1/mongodb/user/add/google':
 *  get:
 *    tags:
 *     - MongoDB Google Auth Controller
...
/**
 * @openapi
 * '/api/v1/mongodb/user/add/google/callback':
 *  get:
 *      tags:
 *       - MongoDB Google Auth Controller
...
/**
 * @openapi
 * '/api/v1/mongodb/user/add/google/confirm':
 *  post:
 *      tags:
 *       - MongoDB Google Auth Controller
