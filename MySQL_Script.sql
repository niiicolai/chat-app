...
-- Edit the room join setting to include a join message and a join channel
call edit_room_join_setting_proc(@room_uuid, 'Welcome to the room!', @ch_uuid, @result);
...
CREATE USER IF NOT EXISTS 'chat_user'@'localhost' IDENTIFIED BY 'password';
-- Grant EXECUTE privilege on stored procedures
GRANT EXECUTE ON PROCEDURE `chat`.`check_upload_exceeds_total_proc` TO 'chat_user'@'localhost';
...
GRANT EXECUTE ON PROCEDURE `chat`.`delete_user_avatar_proc` TO 'chat_user'@'localhost';
...
GRANT EXECUTE ON PROCEDURE `chat`.`leave_room_proc` TO 'chat_user'@'localhost';
GRANT EXECUTE ON PROCEDURE `chat`.`delete_room_file_proc` TO 'chat_user'@'localhost';
GRANT EXECUTE ON PROCEDURE `chat`.`create_room_invite_link_proc` TO 'chat_user'@'localhost';
GRANT EXECUTE ON PROCEDURE `chat`.`edit_room_invite_link_proc` TO 'chat_user'@'localhost';
GRANT EXECUTE ON PROCEDURE `chat`.`delete_room_invite_link_proc` TO 'chat_user'@'localhost';
...
GRANT SELECT ON `chat`.`user_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_user_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_user_role_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_category_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_file_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_file_type_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_avatar_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_audit_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_audit_type_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`room_invite_link_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_type_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_audit_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_audit_type_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_message_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_message_type_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_webhook_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_webhook_message_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_webhook_message_type_view` TO 'chat_user'@'localhost';
...
CREATE USER IF NOT EXISTS 'chat_guest'@'localhost' IDENTIFIED BY 'password';
-- Grant SELECT privilege on views only
GRANT SELECT ON `chat`.`user_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_user_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_user_role_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_category_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_file_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_file_type_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_avatar_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_audit_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_audit_type_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`room_invite_link_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_type_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_audit_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_audit_type_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_message_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_message_type_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_message_upload_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_message_upload_type_view` TO 'chat_user'@'localhost';
GRANT SELECT ON `chat`.`channel_webhook_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_webhook_message_view` TO 'chat_guest'@'localhost';
GRANT SELECT ON `chat`.`channel_webhook_message_type_view` TO 'chat_guest'@'localhost';
-- Flush privileges to apply changes
FLUSH PRIVILEGES;


-- Create a user with restricted reading privileges, which will be unable to see some data
CREATE USER IF NOT EXISTS 'chat_restricted'@'localhost' IDENTIFIED BY 'password';
-- Grant SELECT privilege on views only
GRANT SELECT ON `chat`.`room_audit_view` TO 'chat_restricted'@'localhost';
GRANT SELECT ON `chat`.`room_audit_type_view` TO 'chat_restricted'@'localhost';
GRANT SELECT ON `chat`.`channel_audit_view` TO 'chat_restricted'@'localhost';
GRANT SELECT ON `chat`.`channel_audit_type_view` TO 'chat_restricted'@'localhost';
-- Flush privileges to apply changes
FLUSH PRIVILEGES;
